...
const FullQuestion = (props) => {
  ...
  return (
    <div>
      ...
      <p className="answered-question-format">{props.workOn ?? "placeholder"}</p>
      <h3 className="h3-format">What are you trying to achieve?</h3>
      <p className="answered-question-format">{props.tryAchieve ?? "placeholder"}</p>
      <h3 className="h3-format">What is the issue you are having?</h3>
      <p className="answered-question-format">{props.issue ?? "placeholder"}</p>
      <h3  className="h3-format">What have you attempted?</h3>
      <p className="answered-question-format">{props.attempted ?? "placeholder"}</p>
      <h3>Date asked</h3>
